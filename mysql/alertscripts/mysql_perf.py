...
class Mysql(object):
    ...
    def __init__(self, iphost="localhost", username="root", password="2T50da3zZ37mGy9g", port=3306, force=False, debug=True):
        self._iphost = iphost
...
def main():
    ...
    username = options.username if options.username else "root"
    password = options.password if options.password else "2T50da3zZ37mGy9g"
    port = options.port
